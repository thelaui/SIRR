...
Line3D::Line3D(Point3D const& a, Point3D const& b):
    a_(a),
    b_(b) {
...
Point3D const& Line3D::get_a() const {
    return a_;
}

Point3D const& Line3D::get_b() const {
    return b_;
}

Point3D const Line3D::intersects(Line3D const& l) const {
